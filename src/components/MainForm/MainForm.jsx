...
//получить значение свойства value input
...
//     console.log("номер кошелька: " + inputElement.value);
// };

//const [inputValue, setInputValue] = useState('');
const [selectedBonusArray, setSelectedBonusArray] = useState('');
//
...
const handleButtonClick = (e) => {
  setSelectedBonusArray(inputValue);
 e.preventDefault();//убирает стандартную реакцию браузера на перезагрузку после нажатия кнопки
    ...
    <>
            <main className="place-items-center text-white">
                ...
                <form className="mt-2 grid grid-cols-[116px_240px] gap-3 text-white md:grid-cols-[116px_328px]">
                    ...
                    <input placeholder="Введите количество бонусов" type="number" /*value={inputValue} onChange={handleChange}*/ className="custom_box custom_hover h-[60px] w-full p-2" />
                    ...
                    <div>
                        ...
                        <input placeholder="Итоговая сумма" disabled className="custom_box block h-[60px] w-full p-2" />
                  ...
                  <label className="relative col-span-2">
                        ...
                        <input placeholder="Номер кошелька" /*value={inputValue} onChange={handleInputChange}*/ className="custom_box custom_hover h-[60px] w-full p-2 pr-16" />

                       

                        <button onMouseEnter={handleChildClick} onClick={handleButtonClick} className="custom_send_button_hover absolute top-2 right-2 flex h-[44px] w-[44px] items-center justify-center rounded-xl bg-[rgb(74,_41,_192)]">
                            <DragSvgLock>
